...
st.set_page_config(page_title="Iris project - Komal")

# Add title in browsers body
st.title("Iris End to End project - Komal Thorat")
...
if submit:
    ...
    # show probability in prgress bar
